...
// draw the background
	...
	Com_sprintf (version, sizeof(version), "id Tech 2 v%4.2f + Chicken Scheme", VERSION);
	for (x=0 ; x<32 ; x++)
#ifdef QMAX
		re.DrawChar (viddef.width-260+x*8, lines-12, 128+version[x],1);
#else
		re.DrawChar (viddef.width-260+x*8, lines-12, 128 + version[x] );
#endif
